...
def Main():
    """
    Main game function - runs on start up
...
class Puzzle():
    ...
    def __LoadPuzzle(self, Filename):
        """
        Puzzle is loaded using the file name with try except statement if file isn't found
    ...
    def __GetCell(self, Row, Column):
        """
        Gets value from cell, located using row and column as arguments
    ...
    def CheckforMatchWithPattern(self, Row, Column):
        """
        Checks for matches with the predefined patterns
    ...
    def __GetSymbolFromUser(self):
        """
        Get a valid symbol from the user
    ...
    def __CreateHorizontalLine(self):
        """
        Create a horizontal line and return for use in puzzle display

        Returns
        -------
        str: Line(combination of -O)
        """
        Line = "  "
    ...
    def SavePuzzle(self, Filename):
        with open(Filename, 'w') as my_file:
            my_file.write(f"{len(self.__AllowedSymbols)}\n")
            for symbol in self.__AllowedSymbols:
                my_file.write(f"{symbol}\n")
            my_file.write(f"{len(self.__AllowedPatterns)}")
            for pattern in self.__AllowedPatterns:
                my_file.write(f"{pattern.GetSymbol()},{pattern.GetPatternSequence()}\n")
            my_file.write(f"{self.__GridSize}\n")
...
class Pattern():
    def __init__(self, SymbolToUse, PatternString):
        """
        Initialises a pattern with a symbol and pattern sequence
    ...
    def MatchesPattern(self, PatternString, SymbolPlaced):
        """
        Check if the given pattern matches the provided sequence
    ...
    def GetSymbol(self):
        """
        Get the symbol used in pattern
...
class Cell():
    def __init__(self):
        """
        Initialise a cell with an empty symbol and disallowed symbols list
    ...
    def ChangeSymbolInCell(self, NewSymbol):
        """
        Changes the symbol in the cell
    ...
    def CheckSymbolAllowed(self, SymbolToCheck):
        """
        Check if a symbol is allowed in the cell
    ...
    def AddToNotAllowedSymbols(self, SymbolToAdd):
        """
        Add a symbol to the disallowed symbols list
    ...
    def UpdateCell(self):
        """
        Update the cell (empty method) --> to be implemented
...
class BlockedCell(Cell):
    def __init__(self):
        """
        Initalise a blocked cell with symbol '@'
    ...
    def CheckSymbolAllowed(self, SymbolToCheck):
        """
        Check if a symbol is allowed in the blocked cell
